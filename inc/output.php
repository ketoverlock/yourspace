...
function ys_customize_css() {
    ...
    <style id="customizer-css" type="text/css">
        ...
        <?php if ($orange_dark): ?>
        button:hover,button:focus,input[type="button"]:hover,input[type="button"]:focus,input[type="reset"]:hover,input[type="reset"]:focus,input[type="submit"]:hover,input[type="submit"]:focus,.button:hover,.button:focus,.more-link:hover,.more-link:focus, .wp-block-button__link:hover, .wp-block-button__link:focus { background-color: <?php echo $orange_dark; ?>; } button:hover,button:focus,input[type="button"]:hover,input[type="button"]:focus,input[type="reset"]:hover,input[type="reset"]:focus,input[type="submit"]:hover,input[type="submit"]:focus,.button:hover,.button:focus,.more-link:hover,.more-link:focus, .wp-block-button__link:hover, .wp-block-button__link:focus { border-color: <?php echo $orange_dark; ?>; } a:focus, a:hover, .required, .blurbs-title,.entry-title,.page-title,.comments-title,.comment-reply-title,.woocommerce-tabs h2,.related>h2, .blurbs-title a,.entry-title a,.page-title a,.comments-title a,.comment-reply-title a,.woocommerce-tabs h2 a,.related>h2 a, .entry-content h1,.entry-content h2,.entry-content h3,.entry-content h4,.entry-content h5,.entry-content h6,.blurbs-content h1,.blurbs-content h2,.blurbs-content h3,.blurbs-content h4,.blurbs-content h5,.blurbs-content h6 { color: <?php echo $orange_dark; ?>; }
