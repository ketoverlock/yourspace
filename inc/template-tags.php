...
if ( ! function_exists( 'yourspace_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function yourspace_posted_on() {
...
if ( ! function_exists( 'yourspace_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'yourspace_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function yourspace_entry_footer() {
...
if ( ! function_exists( 'yourspace_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function yourspace_post_thumbnail() {
